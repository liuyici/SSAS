...
class LMMD_loss(nn.Module):
    def __init__(self, class_num=3, kernel_type='rbf', kernel_mul=2.0, kernel_num=5, fix_sigma=None):
    ...
    def cal_weight(self, s_label, t_label, batch_size=32, class_num=3):
        batch_size = s_label.size()[0]
        s_sca_label = s_label.cpu().data.numpy()
        s_sca_label = [x for sublist in s_sca_label for x in sublist]
